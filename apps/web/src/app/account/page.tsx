      ...
      <section className="mx-auto max-w-3xl rounded-3xl border border-white/10 bg-zinc-950/85 p-6 shadow-2xl sm:p-10">
        ...
        {profile ? (
          <div className="mt-10">
            ...
            <p className="mt-8 rounded-xl border border-white/10 bg-white/[0.03] p-4 text-sm leading-6 text-zinc-300">Sua conta está pronta. Biblioteca, diário e avaliações serão vinculados somente a este perfil interno.</p>
          </div>
        ) : (
